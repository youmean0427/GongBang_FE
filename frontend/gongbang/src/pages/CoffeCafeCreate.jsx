...
export default function CoffeCafeCreate(){
    ...
    <div>
        ...
        <div>name</div>
        <div><input name = "name" onChange={onChange}/></div>
        <div>adress</div>
        <div><input name = "address" onChange={onChange}/></div>
        <div>time</div>
        <div><input name = "time" onChange={onChange}/></div>
        <div>total_score</div>
        <div><input name = "total_score" onChange={onChange}/></div>
        <div>lat</div>
        <div><input name = "lat" onChange={onChange}/></div>
        <div>lng</div>
        <div><input name = "lng" onChange={onChange}/></div>

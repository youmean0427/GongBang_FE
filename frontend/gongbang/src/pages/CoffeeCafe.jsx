    ...
    if (data) {
      const filtered = data.filter((cafe) => {
        const distance = CalculateDistance(
          moveState.center.lat,
          moveState.center.lng,
          cafe.lat,
          cafe.lng,
        )
      ...
      <div className="coffeecafe">
        <div>
          ...
          >
            ...
            <MapMarker position={moveState.center}></MapMarker>
              ...
              >
                {isOpen && index === clickIdx && (
                  <div className="coffeecafe-map-modal">
                    <div
                      className="coffeecafe-map-modal-close"
                      onClick={() => setIsOpen(false)}
                    >
                      X
                    </div>
                    {cafe.coffeecafeimage_set.length ? (
                      <div className="coffeecafe-map-modal-image-container">
                        <img
                          className="coffeecafe-map-modal-image"
                    ...
                    <div className="coffeecafe-map-modal-info">
                      <Link to={`/coffeecafe/${cafe.id}`}>
                        <div className="coffeecafe-map-modal-info-flex">
                          <div className="coffeecafe-map-modal-name">
                            {cafe.name}
                          </div>
                          <div className="coffeecafe-map-modal-score">
                            {cafe.total_score}
                          </div>
                        </div>
                        <div className="coffeecafe-map-modal-info-flex">
                          <div className="coffeecafe-map-modal-address">
                            {cafe.address}
                          </div>
                        </div>
                      </Link>

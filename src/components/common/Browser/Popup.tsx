...
export default function Popup() {
      ...
      <div className="flex flex-col justify-between ml-10 mr-5 h-[450px] items-center pt-0 relative ">
        <div className="w-full">
          <div className="flex flex-col items-start justify-start w-full h-full ">
            <div className="p-3 mb-1 text-base font-medium text-white badge border-[#E7B98E] bg-[#E7B98E] ">
              공부다방
            </div>
            <div className="mt-3 mb-3 text-4xl font-bold ">공방</div>
            ...
            <div className="text-lg font-medium ">
              공방은 여러분의 <span className="">카페 정보가 필요합니다!</span>
            </div>
            <div className="w-[350px] mt-5 p-2 text-lg font-medium text-center text-white rounded-lg  bg-[#E7B98E]">
              로그인 → 상단 메뉴 → 카페 추천
            </div>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col justify-between ml-7 mr-5 h-[340px] items-center pt-0 relative ">
      <div className="w-full">
        <div className="flex flex-col items-start justify-start w-full h-full ">
          <div className="pt-1 pb-1 pl-2 pr-2 text-xs font-semibold text-white  rounded-lg  border-[#E7B98E] bg-[#E7B98E] ">
            공부다방
          </div>
          ...
          <div className="text-sm font-medium ">
            여러분의
            <span> 카페 정보가 필요합니다!</span>
          </div>
          <div className=" mt-4 pl-4 pr-4 pt-[6px] pb-[6px] text-sm font-medium text-center text-white rounded-lg  bg-[#E7B98E]">
            로그인 → 마이페이지 → 카페추천
          </div>
        </div>
      </div>
